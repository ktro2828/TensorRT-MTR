#ifndef KNN_BATCH_MLOGK_HPP
#define KNN_BATCH_MLOGK_HPP
 ...
 */
class KnnBatchMlogK : public TRTPluginBase
{
public:
  KnnBatchMlogK(const std::string & name, const int32_t top_k);
  KnnBatchMlogK(const std::string & name, const void * data, size_t length);
  ~KnnBatchMlogK() TRT_NOEXCEPT override;
...
class KnnBatchMlogKCreator : public TRTPluginCreatorBase
{
public:
